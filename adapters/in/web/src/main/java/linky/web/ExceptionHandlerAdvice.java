...
//				.body(new ApiError.Builder(HttpStatus.NOT_FOUND, e.getMessage()).build());
//	}
//
...
//				.body(new ApiError.Builder(HttpStatus.CONFLICT, e.getMessage()).build());
//	}
//
...
//				.body(new ApiError.Builder(HttpStatus.BAD_REQUEST, e.getMessage()).build());
//	}
//
